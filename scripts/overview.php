  ...
  while($mostrecent = $result4->fetchArray(SQLITE3_ASSOC)) {
    ...
    ?>
        ...
        <table class="<?php echo ($_GET['previous_detection_identifier'] == 'undefined') ? '' : 'fade-in';  ?>">
          ...
          <tr>
            <td class="relative"><a target="_blank" href="index.php?filename=<?php echo $mostrecent['File_Name']; ?>"><img class="copyimage" title="Open in new tab" width="25" height="25" src="images/copy.svg"></a>
                        ...
                        <td id="recent_detection_middle_td">
                            <div><form action="" method="GET">
                                    ...
                                    <br><i><?php echo $todaytable['Sci_Name']; ?><br>
                                        <a href="<?php echo $url; ?>" target="_blank"><img style="height: 1em;cursor:pointer;float:unset;display:inline" title="<?php echo $url_title; ?>" src="images/info.svg" width="25"></a>
                                        <a href="https://wikipedia.org/wiki/<?php echo $sciname; ?>" target="_blank"><img style="height: 1em;cursor:pointer;float:unset;display:inline" title="Wikipedia" src="images/wiki.svg" width="25"></a>
                                        ...
                                        <?php endif; ?>
                                        <a target="_blank" href="index.php?filename=<?php echo $todaytable['File_Name']; ?>"><img style="height: 1em;cursor:pointer;float:unset;display:inline" class="copyimage-mobile" title="Open in new tab" width="16" src="images/copy.svg"></a>
                                    </i>
                            </form></div>
                        </td>
